...
import 'package:radicalcare/features/home/home_page/view/widgets/storage_service.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  // Tải fullname từ SecureStorage
  Future<void> _loadFullname() async {
    String? fullname = await _storageService.getFullName();
    setState(() {
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: headerSection(context, imagePath: AppImages.homeBanner, fullName: _fullname), // Truyền fullname vào
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
